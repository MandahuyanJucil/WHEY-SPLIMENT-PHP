...
<header id="home" class="header">
      ...
      <div class="header__firstdiv">
        ...
        <div class="header__firstdiv__fourth">
         <a href="/WHEY SUPPLIMENT/HTML/cart.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
        </div>
        
        <div class="header__firstdiv__fifth">
          <h2 class="header__firstdiv__fifth__h2">About Us</h2>
        </div>
      ...
      <div class="header__seconddiv ">
          <ul class="header__seconddiv__ul">
             <li class="header__seconddiv__li"> <a href="/WHEY SUPPLIMENT/HTML/main.php">Home</a></li>
             <li class="header__seconddiv__li"> <a href="/WHEY SUPPLIMENT/HTML/login.php">log in</a></li>
             <li class="header__seconddiv__li"><a href="/WHEY SUPPLIMENT/HTML/category.php">Category</a></li>
             <li class="header__seconddiv__li"><a href="/WHEY SUPPLIMENT/HTML/deals.php">Deals</a></li>
             <li class="header__seconddiv__li">Branch</li>
